...
class ActivityChangeState(LoginRequiredMixin, FillInformation, PermissionMixin,
    ...
    def get_success_url(self):
        ...
        if self.request.user.profile.administrative and activity.state == 'A':
            ...
            self.send_email(activity, 'administracion.csj@uc.cl',
                            'administration_approved.html')
            # TODO: preguntarle a jesuri si mail es solo con decanato
            self.send_email(activity, activity.in_charge,
                            'approved_activity.html')
...
class ActivityStatusNotification(LoginRequiredMixin, FillInformation,
    ...
    def form_valid(self, form):
        ...
        form.send_email(form.data['subject'], form.data['body'],
                        'contacto@caiuc.cl', [activity.in_charge])
